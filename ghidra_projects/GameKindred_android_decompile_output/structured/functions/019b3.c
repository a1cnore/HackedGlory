...
void FUN_019b3504(void)

{
  pcRam000000000321a8f0 = FUN_019b3d78;
  _DAT_0321a8e8 = FUN_019b3550;
  DAT_0321a900 = FUN_019b4df8;
  _DAT_0321a8f8 = FUN_019b45d0;
  _DAT_0321a928 = FUN_019b4df8;
  _DAT_0321a920 = FUN_019b3d78;
  return;
}
...
void FUN_019b3550(byte *param_1,byte *param_2,byte *param_3,byte *param_4,byte *param_5,
...

{
  ...
  iVar43 = ((uint)*param_6 + (uint)*param_4 >> 1) + 1;
  uVar3 = iVar43 + (uint)*param_4 >> 1;
  iVar1 = ((uint)*param_5 + (uint)*param_3 >> 1) + 1;
  uVar2 = (iVar5 + uVar3 * 0x6625) - 0x379ad0;
  uVar4 = iVar1 + (uint)*param_3 >> 1;
  if (uVar2 >> 0x16 == 0) {
  ...
  uVar2 = iVar5 + uVar4 * -0x1913 + uVar3 * -0x3408 + 0x220530;
  ...
  *param_7 = cVar41;
  ...
  uVar2 = (iVar5 + uVar4 * 0x811a) - 0x451550;
  param_7[1] = cVar41;
  if (uVar2 >> 0x16 == 0) {
    cVar41 = (char)(uVar2 >> 0xe);
  }
  ...
  if (param_2 != (byte *)0x0) {
    ...
    uVar2 = iVar43 + (uint)*param_6 >> 1;
    uVar4 = iVar6 + -0x379ad0 + uVar2 * 0x6625;
    uVar3 = iVar1 + (uint)*param_5 >> 1;
    if (uVar4 >> 0x16 == 0) {
    ...
    uVar2 = iVar6 + 0x220530 + uVar3 * -0x1913 + uVar2 * -0x3408;
    *param_8 = cVar41;
    if (uVar2 >> 0x16 == 0) {
      cVar41 = (char)(uVar2 >> 0xe);
    }
    ...
    uVar2 = iVar6 + -0x451550 + uVar3 * 0x811a;
    param_8[1] = cVar41;
    if (uVar2 >> 0x16 == 0) {
      cVar41 = (char)(uVar2 >> 0xe);
    }
  ...
  if ((int)uVar2 < param_9) {
    ...
    pcVar42 = param_7 + (-(ulong)(uVar3 >> 0x1f) & 0xfffffffe00000000 | (ulong)uVar2 << 1) +
                        (long)(int)uVar2 + 2;
    do {
      bVar61 = local_c0[uVar38];
      iVar43 = (uint)param_1[uVar38 + (long)(int)uVar2] * 0x4a85;
      uVar3 = iVar43 + -0x379ad0 + (uint)local_c0[(int)uVar38 + 0x10] * 0x6625;
      if (uVar3 >> 0x16 == 0) {
      ...
      uVar3 = iVar43 + 0x220530 + (uint)bVar61 * -0x1913 +
              (uint)local_c0[(int)uVar38 + 0x10] * -0x3408;
      pcVar42[-2] = cVar41;
      if (uVar3 >> 0x16 == 0) {
        cVar41 = (char)(uVar3 >> 0xe);
      }
      ...
      uVar3 = iVar43 + -0x451550 + (uint)bVar61 * 0x811a;
      pcVar42[-1] = cVar41;
      if (uVar3 >> 0x16 == 0) {
        cVar41 = (char)(uVar3 >> 0xe);
      }
    ...
    if ((param_2 != (byte *)0x0) && ((int)uVar2 < param_9)) {
      ...
      do {
        bVar61 = local_a0[uVar38];
        iVar43 = (uint)param_2[uVar38 + (long)(int)uVar2] * 0x4a85;
        uVar3 = iVar43 + -0x379ad0 + (uint)local_a0[(int)uVar38 + 0x10] * 0x6625;
        if (uVar3 >> 0x16 == 0) {
          cVar41 = (char)(uVar3 >> 0xe);
        }
        else {
        ...
        uVar3 = iVar43 + 0x220530 + (uint)bVar61 * -0x1913 +
                (uint)local_a0[(int)uVar38 + 0x10] * -0x3408;
        pcVar42[-2] = cVar41;
        if (uVar3 >> 0x16 == 0) {
          cVar41 = (char)(uVar3 >> 0xe);
        }
...
void FUN_019b3d78(byte *param_1,byte *param_2,byte *param_3,byte *param_4,byte *param_5,
                 byte *param_6,char *param_7,char *param_8,int param_9)

{
  ...
  iVar43 = ((uint)*param_6 + (uint)*param_4 >> 1) + 1;
  uVar36 = iVar43 + (uint)*param_4 >> 1 & 0xff;
  iVar1 = ((uint)*param_5 + (uint)*param_3 >> 1) + 1;
  uVar2 = (iVar4 + uVar36 * 0x6625) - 0x379ad0;
  uVar6 = iVar1 + (uint)*param_3 >> 1 & 0xff;
  if (uVar2 >> 0x16 == 0) {
  ...
  uVar2 = iVar4 + uVar6 * -0x1913 + uVar36 * -0x3408 + 0x220530;
  ...
  *param_7 = cVar42;
  ...
  uVar2 = (iVar4 + uVar6 * 0x811a) - 0x451550;
  param_7[1] = cVar42;
  if (uVar2 >> 0x16 == 0) {
    cVar42 = (char)(uVar2 >> 0xe);
  }
  ...
  if (param_2 != (byte *)0x0) {
    ...
    uVar36 = iVar43 + (uint)*param_6 >> 1 & 0xff;
    uVar2 = iVar5 + -0x379ad0 + uVar36 * 0x6625;
    uVar6 = iVar1 + (uint)*param_5 >> 1 & 0xff;
    if (uVar2 >> 0x16 == 0) {
      cVar42 = (char)(uVar2 >> 0xe);
    }
    else {
    ...
    uVar2 = iVar5 + 0x220530 + uVar6 * -0x1913 + uVar36 * -0x3408;
    *param_8 = cVar42;
    if (uVar2 >> 0x16 == 0) {
      cVar42 = (char)(uVar2 >> 0xe);
    }
    ...
    uVar2 = iVar5 + -0x451550 + uVar6 * 0x811a;
    param_8[1] = cVar42;
    if (uVar2 >> 0x16 == 0) {
      cVar42 = (char)(uVar2 >> 0xe);
    }
  ...
  if ((int)uVar2 < param_9) {
    ...
    uVar36 = iVar4 << 6 | 4;
    do {
      bVar61 = local_c0[uVar39];
      iVar43 = (uint)param_1[uVar39 + (long)(int)uVar2] * 0x4a85;
      uVar6 = iVar43 + -0x379ad0 + (uint)local_c0[(int)uVar39 + 0x10] * 0x6625;
      ...
      uVar6 = iVar43 + 0x220530 + (uint)bVar61 * -0x1913 +
              (uint)local_c0[(int)uVar39 + 0x10] * -0x3408;
      *pcVar3 = cVar42;
      if (uVar6 >> 0x16 == 0) {
        cVar42 = (char)(uVar6 >> 0xe);
      }
      ...
      uVar6 = iVar43 + -0x451550 + (uint)bVar61 * 0x811a;
      pcVar3[1] = cVar42;
      if (uVar6 >> 0x16 == 0) {
        cVar42 = (char)(uVar6 >> 0xe);
      }
    ...
    if ((param_2 != (byte *)0x0) && ((int)uVar2 < param_9)) {
      ...
      uVar36 = iVar4 << 6 | 4;
      do {
        bVar61 = local_a0[uVar39];
        iVar43 = (uint)param_2[uVar39 + (long)(int)uVar2] * 0x4a85;
        uVar6 = iVar43 + -0x379ad0 + (uint)local_a0[(int)uVar39 + 0x10] * 0x6625;
        ...
        uVar6 = iVar43 + 0x220530 + (uint)bVar61 * -0x1913 +
                (uint)local_a0[(int)uVar39 + 0x10] * -0x3408;
        *pcVar3 = cVar42;
        if (uVar6 >> 0x16 == 0) {
          cVar42 = (char)(uVar6 >> 0xe);
        }
